  ...
  return (
    <section className="">
      ...
      <div className="mb-10 flex justify-between items-center">
        <h2 className="text-white text-3xl font-bold">Employees list</h2>
        <Link to={"/employees/new"}>
          <button className="px-5 py-2 rounded-md bg-blue-500 hover:bg-blue-600 text-white font-medium cursor-pointer">
            New Employee
          </button>
        </Link>
      </div>
          ...
          <tbody className="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            {employees.length > 0
              ? employees.map((employee) => (
                  <tr
                    key={employee.id}
                    className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-400"
                  >
                    ...
                    <td className=" px-4 py-3  text-sm flex justify-center gap-2 cursor-pointer">
                      ...
                      <span onClick={() => handleDelete(employee.id)}>
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          fill="currentColor"
                          className="size-5 text-red-500 group-hover:scale-105"
                        >
                          <path
                            fillRule="evenodd"
